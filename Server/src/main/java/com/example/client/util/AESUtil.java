...
public class AESUtil {
     ...
     * @throws Exception
     */
    public static InputStream encryptFile(String key, InputStream in) throws Exception {
        Key k = toKey(Base64.decodeBase64(key));
        byte[] raw = k.getEncoded();
        SecretKeySpec secretKeySpec = new SecretKeySpec(raw, ALGORITHM);
        Cipher cipher = Cipher.getInstance(ALGORITHM);
     ...
     * @throws Exception
     */
    public static void decryptFileAndOutput(String key, InputStream in, OutputStream out) throws Exception {
